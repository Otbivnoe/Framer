...
Pod::Spec.new do |s|
  s.name             = 'Framer'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Framer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Framer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nikita Ermolenko' => 'nikita.ermolenko@rosberry.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Framer.git', :tag => s.version.to_s }
